...
class _NoticeFormState extends State<NoticeForm> {
  ...
  Future<void> _sendData(String id, String title, String content) async {
    final url = Uri.parse('${Constants.baseUrl}/notice/${_isEditing ? 'update' : 'save'}');
  ...
  void _handleSubmit() async {
    ...
    if (_titleController.text.isNotEmpty && _contentController.text.isNotEmpty) {
      try {
        await _sendData(
          _isEditing ? widget.notice!["id"].toString() : adminProvider.admin!.id.toString(),
